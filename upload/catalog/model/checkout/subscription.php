...
class ModelCheckoutSubscription extends Model {
    ...
    public function getSubscriptionByOrderProductId(int $order_id, int $order_extension_id): array {
        $this->db->query("SELECT * FROM  `" . DB_PREFIX . "subscription` WHERE `order_id` = '" . (int)$order_id . "' AND `order_extension_id` = '" . (int)$order_extension_id . "'");
