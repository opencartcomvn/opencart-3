...
class ControllerAccountReward extends Controller {
    public function index(): void {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('account/reward', 'member_token=' . $this->session->data['member_token'], true)
        ];
        ...
        foreach ($results as $result) {
            $data['rewards'][] = [
                ...
                'href'        => $this->url->link('account/order/info', 'member_token=' . $this->session->data['member_token'] . '&order_id=' . $result['order_id'], true)
            ];
        }
        ...
        $pagination->limit = 10;
        $pagination->url = $this->url->link('account/reward', 'member_token=' . $this->session->data['member_token'] . '&page={page}', true);
