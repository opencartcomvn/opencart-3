...
class ControllerAccountDownload extends Controller {
    public function index(): void {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('account/download', 'member_token=' . $this->session->data['member_token'], true)
        ];
        ...
        foreach ($results as $result) {
            if (file_exists(DIR_DOWNLOAD . $result['filename'])) {
                ...
                $data['downloads'][] = [
                    ...
                    'href'       => $this->url->link('account/download/download', 'member_token=' . $this->session->data['member_token'] . '&download_id=' . $result['download_id'], true)
                ];
            }
        }
        ...
        $pagination->url = $this->url->link('account/download', 'member_token=' . $this->session->data['member_token'] . '&page={page}', true);
    ...
    public function download(): void {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('account/download', 'member_token=' . $this->session->data['member_token'], true);

            $this->response->redirect($this->url->link('account/login', 'member_token=' . $this->session->data['member_token'], true));
        }
