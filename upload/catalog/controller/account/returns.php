...
class ControllerAccountReturns extends Controller {
    ...
    public function index(): void {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('account/returns', 'member_token=' . $this->session->data['member_token'] . $url, true)
        ];
        ...
        $pagination->url = $this->url->link('account/returns', 'member_token=' . $this->session->data['member_token'] . '&page={page}', true);
    ...
    public function info(): void {
        ...
        if ($return_info) {
            ...
            $data['breadcrumbs'][] = [
                ...
                'href' => $this->url->link('account/returns/info', 'member_token=' . $this->session->data['member_token'] . '&return_id=' . $this->request->get['return_id'] . $url, true)
            ];
